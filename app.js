...
function calculate() {
    ...
    if (alertBox) {
        ...
        if (bmi < 18.5) {
            ...
            alertText.innerText = "แนะนำคุณควรทานอาหารที่มีพลังงานและโปรตีนสูงขึ้นพร้อมแนะนำให้ออกกำลังกายสร้างกล้ามเนื้อ เพื่อให้ร่างกายมีมวลกล้ามเนื้อและสุขภาพที่แข็งแรงครับ";
        } else if (bmi < 23) {
